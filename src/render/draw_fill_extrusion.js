...
function draw(painter: Painter, source: SourceCache, layer: FillExtrusionStyleLayer, coords: Array<OverscaledTileID>) {
    ...
    if (painter.renderPass === 'offscreen') {
        ...
        for (let i = 0; i < coords.length; i++) {
            drawExtrusion(painter, source, layer, coords[i], depthMode, stencilMode, colorMode);
        }
...
function drawExtrusion(painter, source, layer, coord, depthMode, stencilMode, colorMode) {
